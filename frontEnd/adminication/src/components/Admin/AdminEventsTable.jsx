...
function Table({ columns, data }) {
  ...
  return (
    <table className="mx-auto allEventsTable" {...getTableProps()}>
      <thead className="allEventsTableHead">
        <tr>
          <th>
            <div className="mb-3">
              <Link
              ...
              >
                <button className="editButton my-0 btn-lg">Add Event</button>
              </Link>
            </div>
          </th>
          <th
        ...
        {headerGroups.map((headerGroup) => (
          <tr {...headerGroup.getHeaderGroupProps()}>
            {headerGroup.headers.map((column) => (
              <th key={column.id} className="allEventsTh">
      ...
      <tbody className="allEventsTableBody" {...getTableBodyProps()}>
        {rows.map((row, i) => {
          prepareRow(row);
          return (
            <tr className="allEventsRow" {...row.getRowProps()}>
              {row.cells.map((cell) => {
                return (
                  <td className="allEventsTd" {...cell.getCellProps()}>
                    {cell.render("Cell")}
                  </td>
                );
              })}
